...
func (s *AdminService) CreateEmployee(ctx context.Context, name, email, password string, role model.Role, station *string) (model.User, error) {
	switch role {
	case model.RoleAdmin, model.RoleManager, model.RoleDirectionHead, model.RoleChiefHead, model.RoleReceiver, model.RoleMobileGroup, model.RoleLoading, model.RoleTransit, model.RoleIssue, model.RoleAccounting, model.RoleCourier:
	default:

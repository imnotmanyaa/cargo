...
func (r *Repository) CreateShipment(ctx context.Context, shipment model.Shipment) (model.Shipment, error) {
	...
	_, err := r.pool.Exec(ctx, `
		INSERT INTO shipments (
			...
			receiver_name, receiver_phone, tracking_code, qr_code_id, transport_unit_id, courier_id,
			is_door_to_door, pickup_address, delivery_address, door_to_door_phone,
			payment_required, extra_charge, last_updated_at, created_by, created_at, updated_at
		) VALUES (

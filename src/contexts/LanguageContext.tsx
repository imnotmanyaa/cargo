...
const translations = {
  ru: {
    ...
    noEmployeesFound: 'Сотрудники не найде��ы',
  ...
  kk: {
    ...
    // Corporate Dashboard
    corporateDashboard: 'Корпоративті панелі',
    myShipments: 'Менің жөнелтулерім',
    myShipmentsDesc: 'Корпоративті тасымалдауды басқару',
    pendingPickup: 'Қабылдауға күтінген',
    totalThisMonth: 'Бұл айда барлығы',
    avgDeliveryTime: 'Орта келу уақыты',
    days: 'күн',
    createNewShipment: 'Жаңа жөнелту жасау',
    recentShipments: 'Соңғы жөнелтулер',
